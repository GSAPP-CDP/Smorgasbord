...
![satellite12a]
*Landsat 8, Band 5, October 3, 2017 Puerto Rico*  
...
![spectrum]
*Illustration of Landsat bands and the range of the electromagnetic spectrum that they are sensitive to, via [NASA](https://landsat.gsfc.nasa.gov/satellites/landsat-9/landsat-9-bands/)*  
...
![dock]
*Semi-Automatic Classification Plugin docks and menus*  
...
![infrared]
*A false color image showing the near infrared range with red values*
The combination of bands `6-4-2` is particularly well suited for looking at agriculture. Band 6 includes short-wave infrared (SWIR) light and vegetation appears as shades of green and urban areas or bare soil appear as brown/magenta.

![agriculture]
*A false color image with short-wave infrared highlights agriculture*
