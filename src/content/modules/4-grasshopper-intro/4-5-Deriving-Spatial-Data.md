...
At this point you may be saying to yourself, "Yes, I agree that is all very important to consider when working with data, but I thought we were just going to be doing a simple view analysis of a tower?" As we go through the tutorial you will see that even as something has simple as a view analysis needs to be approached critically.
...
Next, how would we measure something qualitative like view? Or put another way, what is a good view? Is it what you can see? Or how open the view is? Or something else? For this exercise lets go with the openness of the view. How would we measure "openness of view"? Distance! What is the distance between the view, or a point in grasshopper, and the objects (geometry) in the view? Finally, what is a metric that describes this? We will develop two metrics through this tutorial and discuss the benefits and limitations of each.
...
geometry or data type. Always mouse over to check data or gemetry types.
```
...
Ok! We have derived our spatial data and visualized it. The last step is to create metrics that allow us to understand if we are achieving our stated goal. This brings us back to the discussion of bias and simplification that kicked of this module.

*TODO: discussion of potential bias and simplification in the create of metrics.*

![description](images/4-5-7_Metric-Overview.PNG)

![description](images/4-5-7_Threshold.PNG)

## Conclusion

*TODO: summarize the need and steps for being critical of why, how, for whom your spatial data is for*

## Assignment

Do one of the following:
1. One ray perpendicular to the façade does not capture all the obstructions within a field of view. Use the rotate component that Rotates an object in a place to rotate your current sampling ray to create more rays for each point that better cover a field of view. Use the series component to generate your rotation angles. If your rotate rays don't look correct (see image below) take a look at your data tree structure -- you'll need to do some grafting to get everything to work correctly!

![description](images/4-5-8_Assignment1.PNG)

2. In this assignment you will revise your definition to analyze what you can see rather then how far you can see. Modify your definition to analyze views to a specific object, like a landmark building, park or river. To start you will need to generate target points. You could subdivide a curve (river) or subdivide a surface (park of building.) Next you need to connect those points to create view rays. Take a look at the Line Component we did not use. Try Mesh Ray instead of IsoVist Ray -- it has an output more suited to this type of analysis. Finally, don't forget that your tower is also an obstruction! Makes to take that into consideration.
