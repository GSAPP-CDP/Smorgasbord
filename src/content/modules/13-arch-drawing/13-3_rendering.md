...
![editing the box mapping](images/13-3/concrete-adjustments.PNG#img-left)
*Adjusting the Texture Map*


Try using the built-in materials library to texture the terrace, stone wall, and gravel yard too:

![additional textures](images/13-3/additional-textures.PNG#img-left)
...
![raytraced](images/13-3/raytraced.PNG#img-left)
*Raytraced View*
...
![final image](images/13-3/cba-rendering.jpg#img-left)
*Final Image*
